...
export default function PortfolioPage() {
  ...
  return (
    <div className="fade-up">
      <div className={styles.pageHead} style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', flexWrap:'wrap', gap:12 }}>
        <div>
          <h1 className={styles.title}>Portfolio</h1>
          <p className={styles.sub}>Your holdings, P&amp;L and allocation</p>
        </div>
        <button onClick={() => navigate('/pnl')} style={{
